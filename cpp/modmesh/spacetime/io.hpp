...
inline std::ostream & operator<<(std::ostream & os, const Field & sol)
{
    os << "Field(grid=" << sol.grid() << ")";
    return os;
}

inline std::ostream & operator<<(std::ostream & os, const Solver & sol)
{
    os << "Solver(grid=" << sol.grid() << ")";
    return os;
}

inline std::ostream & operator<<(std::ostream & os, const Celm & elm)
{
...
inline std::ostream & operator<<(std::ostream & os, const Selm & elm)
{
...
inline std::ostream & operator<<(std::ostream & os, const InviscidBurgersSolver & sol)
{
    os << "InviscidBurgersSolver(grid=" << sol.grid() << ")";
    return os;
}

inline std::ostream & operator<<(std::ostream & os, const InviscidBurgersCelm & elm)
{
...
inline std::ostream & operator<<(std::ostream & os, const InviscidBurgersSelm & elm)
{
...
inline std::ostream & operator<<(std::ostream & os, const LinearScalarSolver & sol)
{
    os << "LinearScalarSolver(grid=" << sol.grid() << ")";
    return os;
}

inline std::ostream & operator<<(std::ostream & os, const LinearScalarCelm & elm)
{
...
inline std::ostream & operator<<(std::ostream & os, const LinearScalarSelm & elm)
{
