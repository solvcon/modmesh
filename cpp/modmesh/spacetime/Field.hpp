...
inline Field::Field(std::shared_ptr<Grid> const & grid, Field::value_type time_increment, size_t nvar)
    : m_grid(grid)
...
inline void Field::set_time_increment(value_type time_increment)
{
