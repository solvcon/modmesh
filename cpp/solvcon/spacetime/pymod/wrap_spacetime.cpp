...
#include <solvcon/spacetime/spacetime.hpp>

#include <solvcon/spacetime/pymod/wrap_spacetime.hpp>
...
using namespace solvcon::spacetime; // NOLINT(google-build-using-namespace)

class SOLVCON_PYTHON_WRAPPER_VISIBILITY WrapGrid
...
class SOLVCON_PYTHON_WRAPPER_VISIBILITY WrapKernel
...
class SOLVCON_PYTHON_WRAPPER_VISIBILITY WrapField
...
class SOLVCON_PYTHON_WRAPPER_VISIBILITY WrapSolver
...
class SOLVCON_PYTHON_WRAPPER_VISIBILITY WrapCelm
...
class SOLVCON_PYTHON_WRAPPER_VISIBILITY WrapSelm
...
class SOLVCON_PYTHON_WRAPPER_VISIBILITY WrapInviscidBurgersSolver
...
class SOLVCON_PYTHON_WRAPPER_VISIBILITY WrapInviscidBurgersCelm
...
class SOLVCON_PYTHON_WRAPPER_VISIBILITY WrapInviscidBurgersSelm
...
class SOLVCON_PYTHON_WRAPPER_VISIBILITY WrapLinearScalarSolver
...
class SOLVCON_PYTHON_WRAPPER_VISIBILITY WrapLinearScalarCelm
...
class SOLVCON_PYTHON_WRAPPER_VISIBILITY WrapLinearScalarSelm
